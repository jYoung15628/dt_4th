...
// 2. switch 문
// - 하나 이상의 case 문으로 구성
// *default : switch문 내의 모든 case 가 매칭 되지 않을 때 실행
//          - 필수는 아니지만, 사용하길 권장
//          - if문의 else같은 존재
...
// break 문이 없으면 조건을 빠져나가지 않고 아래에 있는 모든 case 의 코드도 실행된다
...
// 전역 객체에 속해 있어 어디서나 접근 가능하고 바로 사용 가능!

let now = new Date();
let now2 = new Date().getHours(); // 시간을 나타내는 메소드
